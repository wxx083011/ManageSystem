  ...
  <div class="container">
    ...
    <div class="table" style="margin-top: 20px;text-align: center">
      <el-table  border  stripe   :data="tableData" style="width: 100%" max-height="700">
        ...
        <el-table-column prop="province" label="OBD诊断协议" ></el-table-column>
        <el-table-column prop="province" label="CALID" ></el-table-column>
        <el-table-column prop="city" label="采集时间" ></el-table-column>
        <el-table-column prop="address" label="发动机温度"></el-table-column>
        <el-table-column prop="zip" label="催化器转化器监控"  ></el-table-column>
        <el-table-column prop="zip" label="加热催化转化器监控"  ></el-table-column>
        <el-table-column prop="zip" label="蒸发系统监控"  ></el-table-column>
        <el-table-column prop="zip" label="二次空气系统监控" style="color: red" ></el-table-column>
        <el-table-column prop="zip" label="A/C系统制冷剂监控"  ></el-table-column>
        <el-table-column prop="zip" label="排气传感器加热器监控"  ></el-table-column>
        <el-table-column prop="zip" label="排气传感器加热监控"  ></el-table-column>
        <el-table-column prop="zip" label="EGR系统和VVT监控"  ></el-table-column>
        <el-table-column prop="zip" label="冷启动辅助系统监控"  ></el-table-column>
        <el-table-column prop="zip" label="增压压力控制系统"  ></el-table-column>
        <el-table-column prop="zip" label="DPF监控"  ></el-table-column>
        <el-table-column prop="zip" label="SCR/NOx吸附器监控"  ></el-table-column>
        <el-table-column prop="zip" label="氧化催化器监控"  ></el-table-column>
        <el-table-column prop="zip" label="失火监控"  ></el-table-column>
        <el-table-column prop="zip" label="燃油系统监控"  ></el-table-column>
        <el-table-column prop="zip" label="综合成分监控"  ></el-table-column>
        ...
        <el-table-column prop="zip" label="IUPR"  width="400"></el-table-column>
